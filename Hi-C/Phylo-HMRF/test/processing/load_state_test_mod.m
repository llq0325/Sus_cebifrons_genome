%% load the states
filename1 = '/lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/Hi-C/Phylo-HMRF/test/CHRALL/estimate_ou_1_1.00_20.mat'; % please specific the filename of state estimation results
...
color_vec1 = importdata('color_vec_mod2.txt');
...
n_iter = 1;
filename_idx = 1;
output_path = 'CHRALL'; % please specify the directory to save the output files
for i = 1:chrom_num
