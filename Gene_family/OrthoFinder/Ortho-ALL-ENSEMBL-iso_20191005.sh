...
~/miniconda2/bin/python ~/miniconda2/bin/orthofinder -t 30 -a 30 -S diamond -f /lustre/nobackup/WUR/ABGC/liu194/analysis/Visayan_Warty_pig_10X/Genome_Compare/OrthoFinder/ENSEMBL_iso_20191005 -M msa -T iqtree
