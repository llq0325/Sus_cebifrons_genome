...
my_species <- c('pseudohap1', 'pseudohap1', 'pseudohap1', 'pseudohap1', 'pseudohap2', 'pseudohap2', 'pseudohap2', 'pseudohap2', 'SSC11.1', 'SSC11.1', 'SSC11.1', 'SSC11.1')
...
my_percentage <- c(85.5, 4.0, 3.0, 7.5, 85.1, 4.0, 3.3, 7.6, 86.5, 2.0, 3.6, 7.9)
my_values <- c(259, 12, 9, 23, 258, 12, 10, 23, 262, 6, 11, 24)
