...
#proteinalignment=protein_alignments.gff

$EVM/EvmUtils/partition_EVM_inputs.pl --genome $genome --gene_predictions $geneprediction --segmentSize 500000 --overlapSize 50000 --partition_listing partitions_list.out
...
$PARAFLY/bin/ParaFly -c commands.list -CPU 10 -shuffle -failed_cmds commands.list.failed
