...
if(defined $repeatscout){
		...
		print OUT "perl $common_bin/qsub-sge.pl --lines 1 --resource  vf=3G  -reqsub  build_lmer_table.sh \n";	
		print OUT "perl $common_bin/qsub-sge.pl --lines 1 --resource  vf=3G  -reqsub  repeatscout_out.sh  \n";	
