...
/lustre/nobackup/WUR/ABGC/liu194/analysis/Visayan_Warty_pig_10X/bin/EMBOSS-6.6.0/emboss/newcpgreport -sequence SCEB.masked.fa -window 100 -shift 1 -minlen 200 -minpc 50 -minoe 0.6 -outfile SCEB.masked.fa.cpgreport
