...
foreach $fasta_file (readdir PATH){
	...
	@commonds = ();
        ...
        if($fasta_file =~ /fasta$/ or $fasta_file =~ /fas$/ or $fasta_file =~ /fa$/){
                ...
                `cp /lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/annotation/Hybrid_Approach_RaGOO/2.homology/alignscore.txt /lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/annotation/Hybrid_Approach_RaGOO/2.homology/blastall /lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/annotation/Hybrid_Approach_RaGOO/2.homology/Perl_script/ref_pep.fa`;
                chdir "$fasta_file";
                `ln -s $genome genome.fasta`;
        `cp /lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/annotation/Hybrid_Approach_RaGOO/2.homology/alignscore.txt ../ 
        cp /lustre/nobackup/WUR/ABGC/liu194/analysis/Vasayan_Warty_pig_10X/annotation/Hybrid_Approach_RaGOO/2.homology/blastall ../`;
